package com.r2r.core.permission;
 ...
 */
@Stateless
public class PermissionEjb extends EntityDaoEjb {
    ...
    public List<Perfil> getEnabledProfiles() {
        return entityManager.createQuery("SELECT p FROM Perfil p WHERE p.estatus = :estatus", Perfil.class)
